...
Write-Host ""
Write-Host "[3/3] Copying launch.bat -> dist\ ..."
$LaunchBat = Join-Path $AdminDir "launch.bat"
if (Test-Path $LaunchBat) {
    ...
    Write-Warning "launch.bat not found -- users will need to run admin-panel.exe manually."
}
