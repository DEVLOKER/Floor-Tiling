...
.NOTES
    Prerequisites (run once):
        pip install pyinstaller cython setuptools cryptography pyarmor
...
try {
    ...
    Write-Host ""
    Write-Host "[5/5] Copying launcher -> $DistDir\ ..."
    ...
    Write-Host "  Size   : $DistSize   (includes both bundled models)"
    Write-Host ""
    ...
    Write-Host "    Double-click launch.bat -> Run with Windows"
    Write-Host "========================================================"
} finally {
    Pop-Location
