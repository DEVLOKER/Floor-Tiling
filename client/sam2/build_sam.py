...
# Simplified model variants mapping
MODEL_VARIANTS = {
    "tiny": {
...
def build_sam2(
    ...
    **kwargs,
    ...
    # Check if config_file is a model variant name (e.g., "tiny", "small", "base_plus", "large")
    if config_file in MODEL_VARIANTS:
        variant = MODEL_VARIANTS[config_file]
        config_file = variant["config"]
        ckpt_path = variant["checkpoint"]
